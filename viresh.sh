...
${ORANGE} __      ___               _            _     
${ORANGE} \ \    / (_)             | |          | |    
${ORANGE}  \ \  / / _ _ __ ___  ___| |__        | |    
${ORANGE}   \ \/ / | | '__/ _ \/ __| '_ \   _   | |    
${ORANGE}    \  /  | | | |  __/\__ \ | | | | |__| |  _ 
${ORANGE}     \/   |_|_|  \___||___/_| |_|  \____/  (_)    ${RED}Version : ${__version__}                                      
                                                

	${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Viresh Jigjeni (IndianHacker)${WHITE}
	EOF
}
...
banner_small() {
 ...
 ${BLUE}__      ___               _            _     
 ${BLUE}\ \    / (_)             | |          | |    
 ${BLUE} \ \  / / _ _ __ ___  ___| |__        | |    
 ${BLUE}  \ \/ / | | '__/ _ \/ __| '_ \   _   | |    
 ${BLUE}   \  /  | | | |  __/\__ \ | | | | |__| |  _ 
 ${BLUE}    \/   |_|_|  \___||___/_| |_|  \____/  (_) ${WHITE} ${__version__}
...
about() {
	...
	cat <<- EOF
		...
		${CYAN}  This Tool is made for educational purpose 
		  ...
		  any misuse of this kit ${RED}!${WHITE}
